...
public class Split {
	public static void main(String[] args) {
		...
		*/
	public static void sandwhichPart1() {
		String ingredients = new String("cheesebreadhambread");
		System.out.println(ingredients.substring(ingredients.indexOf("bread")));
		String[] sandwich = (ingredients.substring(ingredients.indexOf("bread")).split("bread"));
